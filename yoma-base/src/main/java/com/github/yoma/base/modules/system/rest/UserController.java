...
import com.github.yoma.base.modules.system.domain.User;
import com.github.yoma.base.modules.system.domain.vo.UserPassVo;
...
import com.github.yoma.base.modules.system.service.dto.UserQueryCriteria;
import com.github.yoma.common.utils.EncryptUtils;
import com.github.yoma.common.utils.PageUtil;
...
public class UserController {
    ...
    public ResponseEntity getUsers(UserQueryCriteria criteria, Pageable pageable) {
        ...
        if (!ObjectUtils.isEmpty(criteria.getDeptId())) {
            ...
            deptSet.addAll(dataScope.getDeptChildren(deptService.findByParentId(criteria.getDeptId())));
        }
        // 数据权限
    ...
    public ResponseEntity delete(@PathVariable Long id) {
        Integer currentLevel = Collections.min(roleService.findByUsers_Id(SecurityUtils.getUserId()).stream()
            .map(RoleSmallDTO::getLevel).collect(Collectors.toList()));
        Integer optLevel = Collections
            .min(roleService.findByUsers_Id(id).stream().map(RoleSmallDTO::getLevel).collect(Collectors.toList()));
