...
import com.github.yoma.order.businessenum.TimeoutStatusEnum;
 ...
 */
public class TimeoutStatusConverter implements Converter<Integer> {
    ...
    public Integer convertToJavaData(CellData cellData, ExcelContentProperty excelContentProperty,
        ...
        return TimeoutStatusEnum.getCodeByText(stringValue);
    }
