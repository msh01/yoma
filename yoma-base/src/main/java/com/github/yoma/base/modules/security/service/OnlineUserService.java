...
import com.github.yoma.base.modules.security.security.OnlineUser;
...
public class OnlineUserService {
    ...
    public Page<OnlineUser> getAll(String filter, Pageable pageable) {
        ...
        return new PageImpl<OnlineUser>(PageUtil.toPage(pageable.getPageNumber(), pageable.getPageSize(), onlineUsers),
            pageable, onlineUsers.size());
    }
