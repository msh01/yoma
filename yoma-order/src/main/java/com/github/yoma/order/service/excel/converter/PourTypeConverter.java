...
import com.github.yoma.order.businessenum.PourTypeEnum;
 ...
 */
public class PourTypeConverter implements Converter<Integer> {
    ...
    public Integer convertToJavaData(CellData cellData, ExcelContentProperty excelContentProperty,
        ...
        return PourTypeEnum.getCodeByText(stringValue);
    }
